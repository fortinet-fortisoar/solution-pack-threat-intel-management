...
3. Click the **Threat Intel Management** (TIM) card to display the TIM popup:  
   ![TIM popup](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/timpopup.png)
4. Ensure that the prerequisites to installing the TIM solution pack are met. If yes, click **Install** to install the same.  
   ![Installing the TIM solution pack](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/installingtim.png)  
   ...
   ![Threat Intel Management page](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/timDashboard.png)
...
![Threat Intel Management left-navigation collapsed view](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/timDashboardCollapsed.png)
...
![Threat Feeds tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/threatfeeds.png)
...
![Threat Feeds datasets](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/threatfeedsdataset.png)
...
![Threat Feeds- Defining datasets](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/threatfeedsdatasetcovid.png)
...
![Collection and Processing tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/workspacedatasets.png)
...
![Analysis and Production tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/workspaceanalyzes.png)
...
![Task Management](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/workspacetaskManagement.png)
...
![Dissemination and Feedback tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/sharetab.png)

You can generate a threat summary report of your finding by clicking the **Generate Threat Summary Report** button:  
![Generate Threat Summary Report popup](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/geneateThreatSummaryReport.png)
...
![Phishing alert](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/phishing.png)
...
![Feed Configurations - General tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/general.png)
...
![Feed Configurations - Outgoing Feed tab](https://github.com/fortinet-fortisoar/solution-pack-threat-intel-management/raw/release/1.0.0/docs/res/feedConfig.png) 
